...
export const FormularioEditarSolicitud = ({ solicitud, onClose }) => {
    ...
    const [inputValues, setInputValues] = useState({
        ...
        valorEnCreditos: solicitud?.valorEnCreditos || false,
        estado: solicitud?.estado || "Pendiente",
        responsable: solicitud?.responsable || "",
        totalSellos: solicitud?.totalSellos || 1,
        ubicacionData: {
            facultad: solicitud?.ubicacion?.facultad || "",
            estado: solicitud?.ubicacion?.estado || "",
            campus: solicitud?.ubicacion?.campus || "",
            ciudad: solicitud?.ubicacion?.ciudad || "",
            direccion: solicitud?.ubicacion?.direccion || "",
            aula: solicitud?.ubicacion?.aula || "",
        },
        capacidad: solicitud?.capacidad || 0,
    });
    ...
    return (
        <Container w={"100%"}>
            ...
            <CloseButtonLink onClick={onClose} />
