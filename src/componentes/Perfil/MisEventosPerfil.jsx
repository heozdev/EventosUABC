...
import { Card, Stack, CardBody, Image, FormControl, FormLabel, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody } from "@chakra-ui/react";
...
export const MisEventosPerfil = () => {
    ...
    return (
        <Stack spacing={4}>
            ...
            {selectedSolicitud && (
                <Modal isOpen={!!selectedSolicitud} onClose={handleClose} size="5xl">
                    <ModalOverlay />
                    <ModalContent>
